      ...
      body: isLoading
        ...
        child: Column(
          ...
          children: [
            ...
            _buildActionCard(
              'Health Packages',
              'Explore comprehensive packages',
              Icons.inventory_2,
              Colors.orange,
            ),
            _buildActionCard(
...
class _PatientDashboardState extends State<PatientDashboard> {
  ...
  Widget _getSelectedScreen() {
    switch (_selectedIndex) {
      ...
      case 2:
        return HealthPackagesScreen(patientId: patientId);
      case 3:
          ...
          _buildActionCard(
            ...
            Colors.orange,
              ...
              Navigator.push(
                context,
                MaterialPageRoute(
                  builder: (context) => HealthPackagesScreen(patientId: patientId),
                ),
              );
            },
          ),
...
// lib/screens/patient/patient_dashboard.dart
// ENHANCED WITH GLOBAL CART AND FLOATING CART BUTTON
import 'package:flutter/material.dart';
import 'package:supabase_flutter/supabase_flutter.dart';
