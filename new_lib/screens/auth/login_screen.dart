...
class _LoginScreenState extends State<LoginScreen> {
  ...
  Color _getUserTypeColor() {
    return widget.userType == 'patient' ? Colors.blue : Colors.pink;
  }

  IconData _getUserTypeIcon() {
    return widget.userType == 'patient' ? Icons.person : Icons.medical_services;
  }
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      if (response.user != null) {
        ...
        String tableName = widget.userType == 'patient' ? 'patients' : 'doctors';
        ...
        if (mounted) {
          String route = widget.userType == 'patient'
              ? '/patient-home'
              : '/doctor-dashboard';
